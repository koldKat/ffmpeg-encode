...
- Mobile home-screen installation uses maskable VideoKat icons with a dark canvas, allowing Android launchers to crop the icon directly instead of adding a white wrapper.
